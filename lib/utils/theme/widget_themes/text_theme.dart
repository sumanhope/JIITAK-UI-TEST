...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: MFColors.dark),
    titleMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.normal, color: MFColors.dark),
